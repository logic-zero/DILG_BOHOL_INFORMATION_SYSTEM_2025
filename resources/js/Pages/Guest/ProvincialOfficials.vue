        ...
        <div v-if="governor.length > 0" class="mb-8">
            <div class="flex justify-center">
                <div v-for="official in governor" :key="official.id" class="text-center mx-4">
                    <img :src="`/storage/${official.profile_image}`" class="w-80 h-80 rounded-full mx-auto object-cover shadow-lg border border-black" alt="Profile Image" />
        ...
        <div v-if="viceGovernor.length > 0" class="mb-8">
            <div class="flex justify-center">
                <div v-for="official in viceGovernor" :key="official.id" class="text-center mx-4">
                    <img :src="`/storage/${official.profile_image}`" class="w-64 h-64 rounded-full mx-auto object-cover shadow-lg border border-black" alt="Profile Image" />
                    <p class="mt-2 text-lg font-bold">{{ official.name }}</p>
                    <p class="text-sm text-gray-600">{{ official.position }}</p>
                </div>
            </div>
            ...
            <div class="flex justify-center">
                <div class="text-center">
                    <div v-for="official in exOfficio" :key="official.id" class="mb-4">
                        <img :src="`/storage/${official.profile_image}`" class="w-40 h-40 rounded-full mx-auto object-cover shadow-lg border border-black" alt="Profile Image" />
                        <p class="mt-2 text-lg font-bold">{{ official.name }}</p>
                        <p class="text-sm text-gray-600">{{ official.position }}</p>
                    </div>
                </div>
