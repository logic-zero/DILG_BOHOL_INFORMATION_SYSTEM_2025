                ...
                <tbody>
                    <tr v-for="user in usersList" :key="user.id" class="border-b hover:bg-gray-50 transition">
                        <td class="p-3 text-gray-600 break-words flex justify-center">
                            <img v-if="user.profile_image" :src="`/profile_images/${user.profile_image}`" class="w-20 h-20 rounded-full object-cover" alt="Profile Image" />
            ...
            <div v-for="user in usersList" :key="user.id" class="border rounded-lg shadow-md bg-gray-100 p-4">
                <div class="flex justify-center mb-4">
                    <div class="w-32 h-32 rounded-full overflow-hidden border-4 border-white shadow-lg">
                        <img v-if="user.profile_image" :src="`/profile_images/${user.profile_image}`" class="w-full h-full object-cover" alt="Profile Image" />
